...
object Dependencies {
  ...
  lazy val http4sXmlInstances  = "org.http4s"                 %% "http4s-scala-xml"      % "1.0.0-M38.1"
  lazy val swaggerModels       = "io.swagger"                  % "swagger-models"        % "1.6.8"
  ...
  lazy val swaggerUi           = "org.webjars"                 % "swagger-ui"            % "4.17.1"
